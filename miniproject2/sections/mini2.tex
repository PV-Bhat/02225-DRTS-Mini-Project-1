...
Our model is Cao-inspired for the mini-project setting (line-oriented forwarding paths, fixed slope parameters, and three effective queue classes), rather than a full reproduction of every equation in the RTNS/RTS formulations.
...
\begin{itemize}
    ...
    \item \textbf{Simplified CBS credit model.} Equation~\ref{eq:cbs_recovery} is a conservative upper bound on the credit recovery time; the formal analyses in \cite{cao2016tight,cao2016independent,cao2018rts} provide tighter formulations that account for detailed class interactions and eligibility windows.
